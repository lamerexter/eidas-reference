...
export SERVICE_METADATA_URL="http://localhost:$NL_PROXY_NODE_HTTP_PORT/ServiceMetadata"
export CONNECTOR_URL="http://localhost:$CONNECTOR_NODE_HTTP_PORT"
export PROXY_URL="http://localhost:$NL_PROXY_NODE_HTTP_PORT"
export NL_PROXY_URL="http://localhost:$NL_PROXY_NODE_HTTP_PORT"
export FR_PROXY_URL="http://localhost:$FR_PROXY_NODE_HTTP_PORT"
export PROXY_METADATA_URL="http://localhost:$NL_PROXY_NODE_HTTP_PORT/ServiceMetadata"
export NODE_METADATA_SSO_LOCATION="http://localhost:$NL_PROXY_NODE_HTTP_PORT/ColleagueRequest"
export IDP_URL="http://localhost:$NL_STUB_IDP_HTTP_PORT"
export IDP_SSO_URL="http://localhost:$NL_STUB_IDP_HTTP_PORT"
